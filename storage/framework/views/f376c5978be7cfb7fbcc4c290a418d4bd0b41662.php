                    ...
                    <div class="media">
                        <div align="center">
                            <a href="<?php echo e(route('users.show', $topic->user->id)); ?>">
                                <img class="thumbnail img-responsive" src="<?php echo e($topic->user->avatar); ?>" width="300px"
                                     height="300px">
                            </a>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $topic)): ?>
                        <div class="operate">
                            <hr>
                            <a href="<?php echo e(route('topics.edit', $topic->id)); ?>" class="btn btn-default btn-xs pull-left"
                               role="button">
